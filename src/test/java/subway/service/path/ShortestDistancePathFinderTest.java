...
class ShortestDistancePathFinderTest {
    ...
    ShortestDistancePathFinder shortestDistancePathFinder = new ShortestDistancePathFinder();
    ...
    void findTest(List<Object> testData) {
        ...
        SubwayResponse subwayResponse = shortestDistancePathFinder.find(new Station(start), new Station(end));
    ...
    public static Stream<List<Object>> createSubwayTestData() {
        ...
        List<Object> testData1 = List.of("교대역", "양재역", 4, 11, "교대역", "강남역", "양재역");
        List<Object> testData2 = List.of("매봉역", "역삼역", 5, 12, "매봉역", "양재역", "강남역", "역삼역");
        List<Object> testData3 = List.of("양재시민의숲역", "교대역", 14, 14, "양재시민의숲역", "양재역", "강남역", "교대역");
        List<Object> testData4 = List.of("남부터미널역", "역삼역", 7, 8, "남부터미널역", "교대역", "강남역", "역삼역");
        List<Object> testData5 = List.of("강남역", "남부터미널역", 5, 5, "강남역", "교대역", "남부터미널역");
        List<Object> testData6 = List.of("강남역", "강남역", 0, 0, "강남역");
...
//    @DisplayName("[Exception] 서로 연결되어 있지 않은 역이면 예외가 발생한다.")
//    @Test
//    void notConnectTest() {
//        Station newStation1 = new Station("킹짱역");
//        Station newStation2 = new Station("우왕역");
//
//        AdjacentStationRepository.addAdjacentStation(newStation1, newStation2, 0, 0);
//
//        Station start = new Station("교대역");
//
//        Assertions.assertThatThrownBy(() -> shortestDistancePathFinder.find(start, newStation1))
